...
console.log((0, _teamJsonDefault.default));
let users = [];
let issues;
...
for(let i = 0; i < 10; i++)users.push(new User(names[Math.floor(Math.random() * names.length)], names[Math.floor(Math.random() * names.length)], ""));
console.log(users);
